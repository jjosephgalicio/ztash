...
**Spec:** [`docs/superpowers/specs/2026-05-01-ztash-design.md`](../specs/2026-05-01-ztash-design.md)
...
<body class="screen-pin">
  ...
  <main class="app" hidden>
    <header class="topbar">
      <div class="brand"><span class="dot" id="conn-dot"></span> Ztash</div>
...
```js
console.log('Ztash client booted');
...
Run `npm run build` then `npm run start`. Open `http://localhost:4123`, install as PWA (Chrome menu → Install Ztash), close and reopen — the shell should load from cache.
...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-01-ztash-design.md`
...
```bash
git add docs/superpowers/specs/2026-05-01-ztash-design.md
